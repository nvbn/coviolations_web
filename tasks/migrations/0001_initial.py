...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'tasks.violation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prepared_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'raw_data': ('django.db.models.fields.TextField', [], {}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'violations'", 'to': u"orm['tasks.Task']"}),
            'violation': ('django.db.models.fields.CharField', [], {'max_length': '300'})
        }
    }
