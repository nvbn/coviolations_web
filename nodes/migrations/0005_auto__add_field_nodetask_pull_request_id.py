...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeTask.pull_request_id'
        db.add_column(u'nodes_nodetask', 'pull_request_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeTask.pull_request_id'
        db.delete_column(u'nodes_nodetask', 'pull_request_id')
