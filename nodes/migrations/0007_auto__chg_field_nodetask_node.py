...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NodeTask.node'
        db.alter_column(u'nodes_nodetask', 'node', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'NodeTask.node'
        db.alter_column(u'nodes_nodetask', 'node', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        u'nodes.nodetask': {
            ...
            'node': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        u'projects.project': {
            ...
            'run_here': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
