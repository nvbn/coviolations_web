...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.dashboard_branch'
        db.add_column(u'projects_project', 'dashboard_branch',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.dashboard_branch'
        db.delete_column(u'projects_project', 'dashboard_branch')
