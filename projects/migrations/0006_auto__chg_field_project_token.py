...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.token'
        db.alter_column(u'projects_project', 'token', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

    def backwards(self, orm):

        # Changing field 'Project.token'
        db.alter_column(u'projects_project', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=36))
