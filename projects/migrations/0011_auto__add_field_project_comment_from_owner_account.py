...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.comment_from_owner_account'
        db.add_column(u'projects_project', 'comment_from_owner_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.comment_from_owner_account'
        db.delete_column(u'projects_project', 'comment_from_owner_account')
